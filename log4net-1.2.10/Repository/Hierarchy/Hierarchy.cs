...
namespace log4net.Repository.Hierarchy {
  ...
  public class Hierarchy : LoggerRepositorySkeleton, IBasicRepositoryConfigurator, IXmlRepositoryConfigurator {
    ...
    public bool IsDisabled(Level level) {
      ...
      else // If not configured the hierarchy is effectively disabled
        return true;
    }
        ...
        if (node == null) {
          ...
          if (nodeLogger != null) {
            ...
            if (nodeProvisionNode != null)
              ...
              LogLog.Error("Hierarchy: Unexpected object type [" + node.GetType() + "] in ht.",
                           new LogException());
          }
        }
      }
    ...
    internal class LevelEntry {
      ...
      public override string ToString() {
        return "LevelEntry(Value=" + m_levelValue + ", Name=" + m_levelName + ", DisplayName=" +
               m_levelDisplayName +
               ")";
      }
    }
    ...
    #region Nested type: PropertyEntry
