...
namespace log4net.Util {
  ...
  public class WindowsSecurityContext : SecurityContext, IOptionHandler {
    ...
    string m_domainName = Environment.MachineName;
    WindowsIdentity m_identity;
    ImpersonationMode m_impersonationMode = ImpersonationMode.User;
    string m_password;
    string m_userName;
    ...
    /// </para>
    /// </remarks>
    static WindowsIdentity LogonUser(string userName, string domainName, string password) {
      ...
      if (
        ...
        throw new Exception("Failed to LogonUser [" + userName + "] in Domain [" + domainName + "]. Error: " +
                            error);
      }
    ...
    static extern bool LogonUser(String lpszUsername, String lpszDomain, String lpszPassword, int dwLogonType,
    ...
    static extern bool DuplicateToken(IntPtr ExistingTokenHandle, int SECURITY_IMPERSONATION_LEVEL,
    ...
    /// </para>
    /// </remarks>
    sealed class DisposableImpersonationContext : IDisposable {
      readonly WindowsImpersonationContext m_impersonationContext;
