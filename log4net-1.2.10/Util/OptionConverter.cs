...
//		}
    ...
    public static object ConvertStringTo(Type target, string txt) {
      ...
      if (typeConverter != null && typeConverter.CanConvertFrom(typeof (string))) // Found appropriate converter
        return typeConverter.ConvertFrom(txt);
      else if (target.IsEnum) // Target type is an enum.
        ...
        if (meth != null) // Call the Parse method
